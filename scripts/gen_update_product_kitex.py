# One-off generator: emits kitex_gen/product/update_product_types.go
# Run: python scripts/gen_update_product_kitex.py

OUT = """// Code generated manually to match idl/product.thrift UpdateProductRequest. DO NOT EDIT.
...
// UpdateProductResponse is identical on wire to CreateProductResponse (base + product + seller_id).
...
// ProductServiceUpdateProductResult aliases CreateProduct result (same success struct shape).
...
if __name__ == "__main__":
    ...
    path = root / "kitex_gen" / "product" / "update_product_types.go"
